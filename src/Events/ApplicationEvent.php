...
abstract class ApplicationEvent
{
    ...
    public function handle($event): void
    {
        ...
        $breadcrumbEnabled = config('honeybadger.breadcrumbs.enabled', true) &&
            in_array(static::class, config('honeybadger.breadcrumbs.automatic', HoneybadgerLaravel::DEFAULT_EVENTS));

        $eventEnabled = config('honeybadger.events.enabled', false) &&
            in_array(static::class, config('honeybadger.events.automatic', HoneybadgerLaravel::DEFAULT_EVENTS));
